...
struct ShortcutRecorderView: View {
    ...
    private func startCapture() {
        ...
        eventMonitor = NSEvent.addLocalMonitorForEvents(matching: [.flagsChanged, .keyDown, .keyUp, .systemDefined, .leftMouseDown, .rightMouseDown, .otherMouseDown]) { event in
            ...
            if event.type == .keyUp || event.type == .systemDefined {
                return nil
            }
